    ...
    public function run(): void
    {
        ...
        foreach ($roles as $roleData) {
            ...
            $role = Role::updateOrCreate(
                ['name' => $roleData['name']],
                ['description' => $roleData['description'], 'configs' => $roleData['configs'], 'metas' => $roleData['metas'], 'created_by' => 'default']
            );
        ...
        // FEATURES
        $features = [
            ['country' => '*', 'name' => 'User Management', 'code' => 'user_management', 'type' => FeatureTypeEnum::MENU->value],
            ['country' => '*', 'name' => 'POV Management', 'code' => 'pov_management', 'type' => FeatureTypeEnum::MENU->value],
        ];
        ...
        foreach ($modules as $module) {
            $permissions = [
                ['category' => '*', 'resource' =>  $module['code'], 'action' => '*', 'description' => "Full access to {$module['code']} management"],
                ['category' => '*', 'resource' =>  $module['code'], 'action' => 'create', 'description' => "Manage {$module['code']}"],
                ['category' => '*', 'resource' =>  $module['code'], 'action' => 'edit', 'description' => "Manage {$module['code']}"],
                ['category' => '*', 'resource' =>  $module['code'], 'action' => 'delete', 'description' => "Manage {$module['code']}"],
                ['category' => '*', 'resource' =>  $module['code'], 'action' => 'view', 'description' => "Manage {$module['code']}"],
            ];
